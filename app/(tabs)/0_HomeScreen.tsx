    ...
    <View style={styles.mealCard}>
      ...
      <View style={styles.mealCardContent}>
        ...
        <Text style={styles.mealCardDescription}>
          Some sort of description etc. Big Card if we want more information
          here
        </Text>
  ...
  const renderMealCard = ({ item }) => (
    ...
    >
      <TouchableOpacity onPress={() => setSelectedMeal(item)}>
        <Image
          source={item.image? { uri: item.image } : require("@/assets/images/mealfoodH.png")}
          resizeMode="cover"
          style={{
            width: "99%",
          ...
          >
                  ...
                  <View style={styles.parentGreetingAvatar}>
                    <View>
                      ...
                      <Text style={styles.subgreetingText}>
                        What delicious meal are you planning today?
                      </Text>
                    </View>
            ...
            <View style={styles.parentCreateMeal}>
              ...
              <BaseButton
                ...
                textStyle={styles.createMeal}
                textStyleText={styles.myMealsText}
