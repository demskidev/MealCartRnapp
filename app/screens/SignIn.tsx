...
// const SignInScreen = () => {
//   const dispatch = useAppDispatch(); // ✅ hook called here
//   const isLoading = useAppSelector(state => state.auth.loading);
//   const { showLoader, hideLoader } = useLoader();

//   // Create SigninViewModel only once
//   const signinViewModel = useMemo(() => new SigninViewModel(dispatch), [dispatch]);



// const handleSignin = async (values: SigninFormValues) => {
//   try {
//     showLoader(); // show loader only when signin starts
...
//   } finally {
//     hideLoader(); // hide loader after signin finishes
//   }
// };
...
//         >
//           <View style={styles.container}>
//             <Header title={Strings.welcomeBack} description={Strings.signinDescription} />
...
//                       gradientButton
//                       textColor={Colors.white}
//                       onPress={handleSubmit} // ✅ Formik submit
//                       disabled={isLoading}
//                     />
//                   </View>
...
//                   <View style={styles.buttonContainer}>
//                     <BaseButton title={Strings.continueWithGoogle} rightChild={<GoogleIcon />} />
//                     <BaseButton
//                       title={Strings.continueWithApple}
//                       backgroundColor={Colors.black}
//                       textColor={Colors.white}
...
//   scrollContent: { flexGrow: 1, paddingHorizontal: moderateScale(25), justifyContent: "center" },
//   form: { gap: moderateScale(12), marginBottom: verticalScale(12) },
//   container: { gap: moderateScale(35) },
//   middleContainer: { gap: moderateScale(8) },
//   buttonContainer: { gap: verticalScale(10) },
//   footerContainer: { paddingHorizontal: moderateScale(20), paddingBottom: verticalScale(10), backgroundColor: Colors.background },
//   forgotPasswordContainer: { alignSelf: "flex-end", marginVertical: verticalScale(8) },
//   dividerStyle: { marginVertical: verticalScale(50) },
// });
